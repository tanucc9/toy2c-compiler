...
La struttura del codice generato è la seguente:
    - Import librerie;
    _ Dichiarazione delle strutture;
...
Le stringhe sono state gestite come char *, e in alcuni casi abbiamo utilizzato un char [] come variabile temporanea per
 il readln e la concatenazione tra stringhe.
